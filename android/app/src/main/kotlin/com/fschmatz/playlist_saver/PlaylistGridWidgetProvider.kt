...
class PlaylistGridWidgetProvider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            val views = RemoteViews(context.packageName, R.layout.playlist_grid_widget)
            ...
            try {
                ...
                views.setRemoteAdapter(R.id.widget_grid_view, collectionItems)
            } catch (e: Exception) {
                e.printStackTrace()
            }
