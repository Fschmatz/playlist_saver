...
class AppState {
  final List<Playlist> listListen;
  final List<Playlist> listArchive;
  final List<Playlist> listFavorites;
  final List<Playlist> listDownloads;
  final List<Playlist> listAll;
